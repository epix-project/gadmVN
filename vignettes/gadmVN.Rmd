...
```{r}
provinces <- gadm()
sp::plot(provinces, col = provinces$color_economic)
leg <- unique(provinces@data[, c("region_economic", "color_economic")])
legend("topright", legend = leg$region_economic, fill = leg$color_economic, bty = "n")
```
...
```{r}
m2015 <- gadm()
sp::plot(subset(m2015, region_economic %in% c("Northeast", "Northwest", "Red River Delta")), border = "white")
box(bty = "o")
sp::plot(m2015, add = TRUE)
sp::plot(subset(m2015, province == "Ha Noi"), add = TRUE, col = "blue")
sp::plot(subset(m2015, province == "Hoa Binh"), add = TRUE, col = "green")
```
...
sp::plot(subset(m2015, region_economic %in% c("Northeast", "Northwest", "Red River Delta")), border = "white")
box(bty = "o")
sp::plot(m2007, add = TRUE)
sp::plot(subset(m2007, province == "Ha Noi"), add = TRUE, col = "blue")
sp::plot(subset(m2007, province == "Ha Tay"), add = TRUE, col = "yellow")
sp::plot(subset(m2007, province == "Hoa Binh"), add = TRUE, col = "green")
```
...
sp::plot(subset(m2015, region_economic %in% c("Northeast", "Northwest", "Red River Delta")), border = "white")
box(bty = "o")
sp::plot(m1991, add = TRUE)
sp::plot(subset(m1991, province == "Ha Noi"), add = TRUE, col = "blue")
```
...
sp::plot(subset(m2015, region_economic %in% c("Northeast", "Northwest", "Red River Delta")), border = "white")
box(bty = "o")
sp::plot(m2003, add = TRUE)
sp::plot(subset(m2003, province == "Ha Noi"), add = TRUE, col = "blue")
```
